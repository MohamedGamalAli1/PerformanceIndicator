...
public static class PerformanceIndicatorEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PerformanceIndicatorModuleExtensionConfigurator CLASS (in the Domain.Shared project)
